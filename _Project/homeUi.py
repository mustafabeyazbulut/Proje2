...
"")
        ...
        self.overviewBtn = QtWidgets.QPushButton(self.menuFrame)
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.overviewBtn.setIcon(icon1)
        self.overviewBtn.setIconSize(QtCore.QSize(24, 24))
        self.overviewBtn.setCheckable(True)
        self.overviewBtn.setChecked(True)
        self.overviewBtn.setAutoRepeat(False)
        self.overviewBtn.setAutoExclusive(True)
        self.overviewBtn.setObjectName("overviewBtn")
        ...
        self.settingsLbl = QtWidgets.QLabel(self.profileContFrame)
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        self.settingsLbl.setFont(font)
        self.settingsLbl.setAlignment(QtCore.Qt.AlignCenter)
        self.settingsLbl.setObjectName("settingsLbl")
        self.verticalLayout_7.addWidget(self.settingsLbl, 0, QtCore.Qt.AlignTop)
        self.userNameLbl = QtWidgets.QLabel(self.profileContFrame)
        self.userNameLbl.setAlignment(QtCore.Qt.AlignCenter)
        self.userNameLbl.setObjectName("userNameLbl")
        self.verticalLayout_7.addWidget(self.userNameLbl, 0, QtCore.Qt.AlignTop)
        self.userPhotoLbl = QtWidgets.QLabel(self.profileContFrame)
        self.userPhotoLbl.setMinimumSize(QtCore.QSize(50, 50))
        self.userPhotoLbl.setMaximumSize(QtCore.QSize(50, 50))
        self.userPhotoLbl.setText("")
        self.userPhotoLbl.setPixmap(QtGui.QPixmap(":/whiteIcons/white/user.svg"))
        self.userPhotoLbl.setAlignment(QtCore.Qt.AlignCenter)
        self.userPhotoLbl.setObjectName("userPhotoLbl")
        self.verticalLayout_7.addWidget(self.userPhotoLbl, 0, QtCore.Qt.AlignHCenter|QtCore.Qt.AlignTop)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.overviewBtn.setText(_translate("MainWindow", "Overview"))
        ...
        self.appHeader.setText(_translate("MainWindow", "---"))
        ...
        self.settingsLbl.setText(_translate("MainWindow", "Settings"))
        self.userNameLbl.setText(_translate("MainWindow", "-----"))
